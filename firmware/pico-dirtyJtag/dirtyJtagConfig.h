...
#define BOARD_LEBKUCHEN         100

// Select the board type from the above
#define BOARD_TYPE BOARD_LEBKUCHEN
...
#elif ( BOARD_TYPE == BOARD_LEBKUCHEN )
...
#define PIN_CDONE		14
#define PIN_CFAILED	15
#define PIN_CRESET	28
#define PIN_CLK		23
#define PIN_CFG_MD3  29
